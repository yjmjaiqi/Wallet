{/* <script> */}
    ...
    function renderTemplate(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        template += '<h5>第'+'<span style="color:red">'+(i+1)+'</span>'+'笔交易</h5>'+'<h5>交易发送方: ' 
        + data.transactions[i].sender_blockchain_address + 
        '</h5><h5>交易接收方: ' + data.transactions[i].recipient_blockchain_address
        + '</h5>'+'<h5>交易金额: ' + data.transactions[i].value + '</h5><h5>交易哈希: ' 
